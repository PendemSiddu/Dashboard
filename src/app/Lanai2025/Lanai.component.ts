...
@Component({
  selector: 'app-Lanai',
  templateUrl: './Lanai.component.html',
  styleUrls: ['./Lanai.component.scss']
})
export class LanaiComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi50', am4charts.XYChart);
    chart.height = 420;
