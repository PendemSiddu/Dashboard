...
@Component({
  selector: 'app-Artms',
  templateUrl: './Artms.component.html',
  styleUrls: ['./Artms.component.scss']
})
export class ArtmsComponent implements OnInit {
  ...
  constructor() { }
    ...
    ngAfterViewInit() {
      ...
      let chart = am4core.create('fi41', am4charts.XYChart);
      chart.height = 500;
