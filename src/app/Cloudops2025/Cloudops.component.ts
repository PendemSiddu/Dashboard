...
@Component({
  selector: 'app-Cloudops',
  templateUrl: './Cloudops.component.html',
  styleUrls: ['./Cloudops.component.scss']
})
export class CloudopsComponent implements OnInit {
  ...
  constructor() { }
    ...
    ngAfterViewInit() {
      ...
      let chart = am4core.create('fi42', am4charts.XYChart);
      chart.height = 500;
