...
@Component({
  selector: 'app-Mobileopshercules',
  templateUrl: './Mobileopshercules.component.html',
  styleUrls: ['./Mobileopshercules.component.scss']
})
export class MobileopsherculesComponent implements OnInit {
  ...
  constructor() { }
    ...
    ngAfterViewInit() {
      ...
      let chart = am4core.create('fi45', am4charts.XYChart);
      chart.height = 500;
