...
@Component({
  selector: 'app-Ipt',
  templateUrl: './Ipt.component.html',
  styleUrls: ['./Ipt.component.scss']
})
export class IptComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi46', am4charts.XYChart);
    chart.height = 420;
