...
@Component({
  selector: 'app-Sfintegration',
  templateUrl: './Sfintegration.component.html',
  styleUrls: ['./Sfintegration.component.scss']
})
export class SfintegrationComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi48', am4charts.XYChart);
    chart.height = 420;
